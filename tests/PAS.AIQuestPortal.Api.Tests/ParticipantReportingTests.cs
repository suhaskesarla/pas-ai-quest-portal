...
public sealed class ParticipantReportingTests : IAsyncLifetime
{
    ...
    private async Task Seed()
    {
        ...
        db.CycleParticipants.AddRange(new CycleParticipant { CycleId = cycle, ParticipantId = current, Status = CycleParticipantStatus.Active, JoinedAt = now }, new CycleParticipant { CycleId = cycle, ParticipantId = manager, Status = CycleParticipantStatus.Active }, new CycleParticipant { CycleId = cycle, ParticipantId = alpha1, Status = CycleParticipantStatus.Active }, new CycleParticipant { CycleId = cycle, ParticipantId = alpha2, Status = CycleParticipantStatus.Active }, new CycleParticipant { CycleId = cycle, ParticipantId = tied100, Status = CycleParticipantStatus.Active }, new CycleParticipant { CycleId = cycle, ParticipantId = zero, Status = CycleParticipantStatus.Active }, new CycleParticipant { CycleId = cycle, ParticipantId = withdrawn, Status = CycleParticipantStatus.Withdrawn }, new CycleParticipant { CycleId = cycle, ParticipantId = inactive, Status = CycleParticipantStatus.Inactive }, new CycleParticipant { CycleId = closing, ParticipantId = current, Status = CycleParticipantStatus.Active }, new CycleParticipant { CycleId = finalised, ParticipantId = current, Status = CycleParticipantStatus.Inactive }, new CycleParticipant { CycleId = inaccessible, ParticipantId = manager, Status = CycleParticipantStatus.Active });
