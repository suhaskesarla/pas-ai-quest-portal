...
function AuthenticatedShell({ api, reports, challengeAdmin, scoresheet }: { api: WorkflowApi; reports: ReportingApi; challengeAdmin: ChallengeAdminApi; scoresheet: ScoresheetApi }) {
...
export function App({ api = workflowApi, reports = reportingApi, challengeAdmin = challengeAdminApi, scoresheet = scoresheetApi }: { api?: WorkflowApi; reports?: ReportingApi; challengeAdmin?: ChallengeAdminApi; scoresheet?: ScoresheetApi }) {
  ...
  if (status === 'authenticated') return <AuthenticatedShell api={api} reports={reports} challengeAdmin={challengeAdmin} scoresheet={scoresheet} />
