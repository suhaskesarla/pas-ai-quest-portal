...
function AuthenticatedShell({ api, reports, challengeAdmin, scoresheet, cycleAdmin }: { api: WorkflowApi; reports: ReportingApi; challengeAdmin: ChallengeAdminApi; scoresheet: ScoresheetApi; cycleAdmin: CycleAdminApi }) {
...
export function App({ api = workflowApi, reports = reportingApi, challengeAdmin = challengeAdminApi, scoresheet = scoresheetApi, cycleAdmin = cycleAdminApi }: { api?: WorkflowApi; reports?: ReportingApi; challengeAdmin?: ChallengeAdminApi; scoresheet?: ScoresheetApi; cycleAdmin?: CycleAdminApi }) {
  ...
  if (status === 'authenticated') return <AuthenticatedShell api={api} reports={reports} challengeAdmin={challengeAdmin} scoresheet={scoresheet} cycleAdmin={cycleAdmin} />
